    ...
    <div class="flex flex-col mt-6">
        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block w-full py-2 align-middle md:px-6 lg:px-8">
                <div
                    class="overflow-auto scroll-table border border-gray-200 dark:border-gray-700 md:rounded-lg"
                >
                    <table
                        class="table overflow-scroll w-full divide-y divide-gray-200 dark:divide-gray-700"
                    >
                        <slot
                            name="thead"
